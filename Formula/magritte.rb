class Magritte < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/lyallcooper/magritte/releases/download/v0.1.0/magritte-v0.1.0-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/lyallcooper/magritte/releases/download/v0.1.0/magritte-v0.1.0-x86_64-unknown-linux-gnu.tar.gz"
